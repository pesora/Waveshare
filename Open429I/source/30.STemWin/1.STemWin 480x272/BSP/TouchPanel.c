...
{
  GUI_DrawHLine(Ypos, Xpos-13, Xpos-3);
	GUI_DrawHLine(Ypos, Xpos+4, Xpos+14);
	GUI_DrawVLine(Xpos, Ypos-13, Ypos-3);
	GUI_DrawVLine(Xpos, Ypos+4,Ypos+14);	
...
void TouchPanel_Calibrate(void)
{
  ...
  for(i=0;i<3;i++)
  {
		...
		GUI_DispStringAt("Touch crosshair to calibrate", (LCD_GetXSize()-250)/2, (LCD_GetYSize()-20)/2);
		HAL_Delay(200);
