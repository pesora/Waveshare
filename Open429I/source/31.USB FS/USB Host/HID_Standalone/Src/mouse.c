...
#define MOUSE_WINDOW_HEIGHT             250
#define MOUSE_WINDOW_WIDTH              550

#define HID_MOUSE_BUTTON_HEIGHT         30
#define HID_MOUSE_BUTTON_WIDTH          60
#define HID_MOUSE_BUTTON1_XCHORD        250
#define HID_MOUSE_BUTTON2_XCHORD        350
#define HID_MOUSE_BUTTON3_XCHORD        450
#define HID_MOUSE_BUTTON_YCHORD         400
